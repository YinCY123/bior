...
```{r}
expression_matrix <- readRDS(file = "f:/git/Data/monocle/packer_embryo_expression.rds")
cell_metadata <- readRDS(file = "f:/git/Data/monocle/packer_embryo_colData.rds")
gene_metadata <- readRDS(file = "f:/git/Data/monocle/packer_embryo_rowData.rds")
