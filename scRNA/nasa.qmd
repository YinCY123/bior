...
GSE122465 <- fread("/home/yincy/git/data/parttime/nasa/ref/GSE122465/GSE122465_FilteredCounts10x.csv.gz", 
                   sep = ",", 
...
GSE122465 %>% colData
GSE122465 %>% rowData
saveRDS(GSE122465, "/home/yincy/git/data/parttime/nasa/ref/GSE122465.rds")
```
...
colData(GSE122465)
GSE122465 <- readRDS("/home/yincy/git/data/parttime/nasa/ref/GSE122465.rds")
```
...
GSE122465 <- runTSNE(GSE122465, 
                     ...
                     num_threads = 10)
GSE122465
saveRDS(GSE122465, "/home/yincy/git/data/parttime/nasa/ref/processed_GSE122465.rds")
```
...
GSE122465 <- readRDS("/home/yincy/git/data/parttime/nasa/ref/processed_GSE122465.rds")
...
table(nasa$clusters, pred_label$pruned.labels) %>% prop.table(margin = 1) %>% round(digits = 2) %>% .[, ]
pred_label$pruned.labels %>% table(useNA = "ifany")
