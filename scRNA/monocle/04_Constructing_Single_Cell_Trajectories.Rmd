...
```{r}
expression_matrix <- readRDS("../../../data/monocle3/packer/packer_embryo_expression.rds")
cell_metadata <- readRDS("../../../data/monocle3/packer/packer_embryo_colData.rds")
gene_annotation <- readRDS("../../../data/monocle3/packer/packer_embryo_rowData.rds")
...
As with clustering analysis, you can use `plot_cells()` to visualize how indivdual genesvary along thetrajectory. Let's look at some genes with interesting patterns of expression in ciliated neurons.  
...
Next, we will fit a pricipal graph within each partition using the `learn_graph()` function. 
