...
nasa <- readRDS("/home/yincy/git/data/parttime/nasa/processed_nasa.rds")
...
nasa %>% colData()
saveRDS(nasa, "/home/yincy/git/data/parttime/nasa/processed_nasa.rds")
```
...
fmarkers <- findMarkers(x = nasa, 
                        groups = nasa$levels, 
                        restrict = c("FLT_OLD_large pre-B.", "GC_OLD_large pre-B."), 
                        # block = nasa$Sample, 
