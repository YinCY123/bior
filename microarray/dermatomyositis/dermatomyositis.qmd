...
query <- GDCquery(project = "TCGA-COAD", 
                  ...
                  sample.type = c("TR", "NT", "CELLC"))
```

```{r}
projects %>% dplyr::filter(grepl("colon", name, ignore.case = T))
projects[2, "disease_type"]

projects$disease_type %>% sapply(function(x){str_detect(x, "colon")})
```
