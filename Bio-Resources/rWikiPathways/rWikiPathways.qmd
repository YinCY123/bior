...
readPathwayGMT("/home/yincy/git/data/WikiPathways/human/wikipathways-20240310-gmt-Homo_sapiens.gmt")
```


```{r}
downloadPathwayArchive()
downloadPathwayArchive(organism = "Homo sapiens", 
                       destpath = "/home/yincy/git/data/WikiPathways/human/", 
                       format = "gmt", 
                       date = "20240310")
listOrganisms()
```
...
```{r}
hsa.pathways <- listPathways(organism = "Homo sapiens")

wp554_genes <- getXrefList(pathway = "WP554", systemCode = "VmhM")
wp554_genes
```
