---
title: "031_Parameter-optimization-via-mlrMBO"
...
sig_network <- readRDS("../../Data/nichenet/signaling_network.rds")
gr_network <- readRDS("../../Data/nichenet/gr_network.rds")
```
...
```{r}
expression_settings_validation <- readRDS("../../Data/nichenet/expression_settings.rds")
```
...
qsub_config <- create_qsub_config(
  ...
  remote_tmp_path = "/scratch/personal/myclsuter/r2gridengine", 
  num_cores = 24, 
  memory = "10G", 
  wait = FALSE, 
