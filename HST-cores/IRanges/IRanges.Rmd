...
The *NormalIRanges* class formally represents a set of integers. By definition an *IRanges* object is said to be normal when its ranges are: (a) not empty. (b) not overlapping. (c) ordered from left to right. (d) not even adjacent (e.g., there muts be a non empty gap between 2 consecutive ranges.)
