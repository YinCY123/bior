...
```{r}
sce <- read10xCounts(samples = dirname)
```
...
# making a plot
plot(br.out$rank, br.out$total, log = "x", xlab = "Rank", ylab = "Total")
o <- order(br.out$rank)
